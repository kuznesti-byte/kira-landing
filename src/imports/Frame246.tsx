...
export default function Frame5() {
  return (
    <div className="bg-black overflow-clip relative rounded-[16px] size-full">
      <div className="absolute h-[296px] left-0 top-[-35px] w-[444px]" data-name="image 124">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={experienceEvent13} />
      </div>
      <Frame4 />
      <div className="-translate-y-full absolute flex flex-col font-['Manrope:Medium',sans-serif] font-medium justify-end leading-[1.15] left-[14px] text-[24px] text-white top-[185px] whitespace-nowrap">
        <p className="mb-0">Forbes Woman: Дао, бизнес</p>
        <p>и женщины</p>
      </div>
      <div className="absolute font-['Manrope:Regular',sans-serif] font-normal leading-[1.25] left-[14px] text-[14px] text-white top-[14px] whitespace-nowrap">
        <p className="mb-0">Форум женщин-предпринимателей</p>
        <p>с Ириной Хакамадой</p>
      </div>
      <p className="-translate-x-full absolute font-['Manrope:Medium',sans-serif] font-medium leading-[1.25] left-[430px] text-[#6c7179] text-[14px] text-right top-[14px] whitespace-nowrap">2023</p>
    </div>
  );
}